...
Uses mono cecil to add random letters to the internal assembly name (not the file name) in a .NET Framework assembly to allow it to be loaded into a AppDomain if an assembly with the same signature already exists in that AppDomain.
